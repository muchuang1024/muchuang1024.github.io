import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.4aTu-Nia.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/01 学习/课程/Golang/Go 面试/Slice 面试/Go 面试 | Go slice 深拷贝和浅拷贝.md","filePath":"docs/01 学习/课程/Golang/Go 面试/Slice 面试/Go 面试 | Go slice 深拷贝和浅拷贝.md"}'),e={name:"docs/01 学习/课程/Golang/Go 面试/Slice 面试/Go 面试 | Go slice 深拷贝和浅拷贝.md"},l=p(`<p><strong>1、深拷贝</strong></p><p>拷贝的是数据本身，创造一个新对象，新创建的对象与原对象不共享内存，新创建的对象在内存中开辟一个新的内存地址，新对象值修改时不会影响原对象值</p><p>实现深拷贝的方式有 2 种</p><p>1、copy(slice2, slice1)</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>copy(slice2, slice1)</span></span></code></pre></div><p>2、遍历 append 赋值</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>func main() {</span></span>
