import{_ as s,c as a,o as n,a4 as t}from"./chunks/framework.4aTu-Nia.js";const h=JSON.parse(`{"title":"一、GODEBUG='gctrace=1'","description":"","frontmatter":{},"headers":[],"relativePath":"docs/02 技术/Golang/Go 面试/并发面试/Go 面试 | Go 如何查看 GC 信息.md","filePath":"docs/02 技术/Golang/Go 面试/并发面试/Go 面试 | Go 如何查看 GC 信息.md"}`),p={name:"docs/02 技术/Golang/Go 面试/并发面试/Go 面试 | Go 如何查看 GC 信息.md"},e=t(`<p>在 Go 语言中，垃圾回收是一个重要的机制，它负责管理内存的分配和释放，确保程序运行过程中不会出现内存泄漏等问题。为了更好地了解和调试 Go 的垃圾回收过程，可以使用以下四种方式</p><h1 id="一、godebug-gctrace-1" tabindex="-1">一、GODEBUG=&#39;gctrace=1&#39; <a class="header-anchor" href="#一、godebug-gctrace-1" aria-label="Permalink to &quot;一、GODEBUG=&#39;gctrace=1&#39;&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package main</span></span>
