import{_ as s,c as a,o as n,a4 as p}from"./chunks/framework.4aTu-Nia.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/02 技术/运筹优化/求解器/scip.md","filePath":"docs/02 技术/运筹优化/求解器/scip.md"}'),e={name:"docs/02 技术/运筹优化/求解器/scip.md"},l=p(`<p>#运筹优化 #求解器</p><h2 id="下载" tabindex="-1">下载 <a class="header-anchor" href="#下载" aria-label="Permalink to &quot;下载&quot;">​</a></h2><p>Scip是集成在SCIP Optimization Suite下的，通过页面 <a href="https://scipopt.org/index.php#download" target="_blank" rel="noreferrer">https://scipopt.org/index.php#download</a> 下载对应系统的安装包</p><p><a href="https://scipopt.org/download.php?fname=scipoptsuite-8.0.3.tgz" target="_blank" rel="noreferrer">https://scipopt.org/download.php?fname=scipoptsuite-8.0.3.tgz</a></p><h2 id="编译安装" tabindex="-1">编译安装 <a class="header-anchor" href="#编译安装" aria-label="Permalink to &quot;编译安装&quot;">​</a></h2><h3 id="_1-安装依赖" tabindex="-1">1. 安装依赖 <a class="header-anchor" href="#_1-安装依赖" aria-label="Permalink to &quot;1. 安装依赖&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>brew install gcc</span></span>
