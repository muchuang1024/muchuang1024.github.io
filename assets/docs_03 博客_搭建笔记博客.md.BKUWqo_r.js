...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><h3 id="三-、部署到-github" tabindex="-1">三）、部署到 Github <a class="header-anchor" href="#三-、部署到-github" aria-label="Permalink to &quot;三）、部署到 Github&quot;">​</a></h3><p>运行部署脚本，这将自动将 <code>dist</code> 目录（或您在 VitePress 配置中指定的其他输出目录）中的文件推送到 <code>gh-pages</code> 分支</p><div class="language-json vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">yarn deploy</span></span></code></pre></div><h3 id="四-、配置-github-pages" tabindex="-1">四）、配置 GitHub Pages <a class="header-anchor" href="#四-、配置-github-pages" aria-label="Permalink to &quot;四）、配置 GitHub Pages&quot;">​</a></h3><p>在 GitHub 仓库的设置（Settings）中，找到“GitHub Pages”部分。 在“Source”下拉菜单中选择 <code>gh-pages</code> 分支</p><p><img src="https://muchuang-img.oss-cn-beijing.aliyuncs.com/20240330232655.png" alt=""></p><h3 id="五-、访问网站" tabindex="-1">五）、访问网站 <a class="header-anchor" href="#五-、访问网站" aria-label="Permalink to &quot;五）、访问网站&quot;">​</a></h3><p>稍等片刻，您的 VitePress 网站应该可以通过 <code>username.github.io</code> 访问了，其中 <code>username</code> 是您的 GitHub 用户名</p><p><img src="https://muchuang-img.oss-cn-beijing.aliyuncs.com/20240330232725.png" alt=""></p>`,55),l=[e];function t(h,c,d,o,r,k){return n(),a("div",null,l)}const u=s(p,[["render",t]]);export{E as __pageData,u as default};
