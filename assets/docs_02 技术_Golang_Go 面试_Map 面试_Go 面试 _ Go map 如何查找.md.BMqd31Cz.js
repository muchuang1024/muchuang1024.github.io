import{_ as s,c as a,o as n,a4 as t}from"./chunks/framework.4aTu-Nia.js";const g=JSON.parse('{"title":"一、查找流程","description":"","frontmatter":{},"headers":[],"relativePath":"docs/02 技术/Golang/Go 面试/Map 面试/Go 面试 | Go map 如何查找.md","filePath":"docs/02 技术/Golang/Go 面试/Map 面试/Go 面试 | Go map 如何查找.md"}'),p={name:"docs/02 技术/Golang/Go 面试/Map 面试/Go 面试 | Go map 如何查找.md"},i=t(`<p>Go 语言中读取 map 有两种语法：带 comma 和 不带 comma。当要查询的 key 不在 map 里，带 comma 的用法会返回一个 bool 型变量提示 key 是否在 map 中；而不带 comma 的语句则会返回一个 value 类型的零值。如果 value 是 int 型就会返回 0，如果 value 是 string 类型，就会返回空字符串。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>// 不带 comma 用法</span></span>
