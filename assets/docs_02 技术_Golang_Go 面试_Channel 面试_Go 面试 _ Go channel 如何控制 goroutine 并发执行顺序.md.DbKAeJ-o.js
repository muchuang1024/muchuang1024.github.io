import{_ as n,c as s,o as a,a4 as p}from"./chunks/framework.4aTu-Nia.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/02 技术/Golang/Go 面试/Channel 面试/Go 面试 | Go channel 如何控制 goroutine 并发执行顺序.md","filePath":"docs/02 技术/Golang/Go 面试/Channel 面试/Go 面试 | Go channel 如何控制 goroutine 并发执行顺序.md"}'),t={name:"docs/02 技术/Golang/Go 面试/Channel 面试/Go 面试 | Go channel 如何控制 goroutine 并发执行顺序.md"},e=p(`<p>多个 goroutine 并发执行时，每一个 goroutine 抢到处理器的时间点不一致，gorouine 的执行本身不能保证顺序。即代码中先写的 gorouine 并不能保证先执行</p><p>思路：使用 channel 进行通信通知，用 channel 去传递信息，从而控制并发执行顺序</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package main</span></span>
