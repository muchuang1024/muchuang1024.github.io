import{_ as n,c as s,o as a,a4 as p}from"./chunks/framework.4aTu-Nia.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/01 学习/课程/Golang/Go 面试/Channel 面试/Go 面试 | Go channel 有无缓冲的区别.md","filePath":"docs/01 学习/课程/Golang/Go 面试/Channel 面试/Go 面试 | Go channel 有无缓冲的区别.md"}'),t={name:"docs/01 学习/课程/Golang/Go 面试/Channel 面试/Go 面试 | Go channel 有无缓冲的区别.md"},l=p(`<p><strong>1、无缓冲</strong></p><p>一个送信人去你家送信，你不在家他不走，你一定要接下信，他才会走。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package main</span></span>
