import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.4aTu-Nia.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/00 创作中/如何从0到1做一个简历评分助手？.md","filePath":"docs/00 创作中/如何从0到1做一个简历评分助手？.md"}'),l={name:"docs/00 创作中/如何从0到1做一个简历评分助手？.md"},e=p(`<h2 id="一、初始化-prompt" tabindex="-1">一、初始化 Prompt <a class="header-anchor" href="#一、初始化-prompt" aria-label="Permalink to &quot;一、初始化 Prompt&quot;">​</a></h2><p>发送给自动结构化框架 GPTs 的提示词：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>针对用户输入的岗位JD和简历，从项目匹配度、专业性等角度对用户的简历进行评分，满分为100分</span></span></code></pre></div><p>得到初版 Prompt</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span># Role: 简历评分助手</span></span>
