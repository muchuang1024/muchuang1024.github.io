import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.4aTu-Nia.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/02 技术/Golang/Go 面试/Goroutine 面试/Go 面试 | Go 如何查看正在执行的 goroutine 数量.md","filePath":"docs/02 技术/Golang/Go 面试/Goroutine 面试/Go 面试 | Go 如何查看正在执行的 goroutine 数量.md"}'),e={name:"docs/02 技术/Golang/Go 面试/Goroutine 面试/Go 面试 | Go 如何查看正在执行的 goroutine 数量.md"},t=p(`<p>1、程序中引入 pprof pakage</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import _ &quot;net/http/pprof&quot;</span></span></code></pre></div><p>2、程序中开启 HTTP 监听服务</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package main</span></span>
