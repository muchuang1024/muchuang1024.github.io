import{_ as s,c as a,o as n,a4 as p}from"./chunks/framework.4aTu-Nia.js";const k=JSON.parse('{"title":"一、扩容时机","description":"","frontmatter":{},"headers":[],"relativePath":"docs/01 学习/课程/Golang/Go 面试/Map 面试/Go 面试 | Go map 如何扩容.md","filePath":"docs/01 学习/课程/Golang/Go 面试/Map 面试/Go 面试 | Go map 如何扩容.md"}'),e={name:"docs/01 学习/课程/Golang/Go 面试/Map 面试/Go 面试 | Go map 如何扩容.md"},l=p(`<h1 id="一、扩容时机" tabindex="-1">一、扩容时机 <a class="header-anchor" href="#一、扩容时机" aria-label="Permalink to &quot;一、扩容时机&quot;">​</a></h1><p>在向 map 插入新 key 的时候，会进行条件检测，符合下面这 2 个条件，就会触发扩容</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>if !h.growing() &amp;&amp; (overLoadFactor(h.count+1, h.B) || tooManyOverflowBuckets(h.noverflow, h.B)) {</span></span>
