import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.4aTu-Nia.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/03 博客/算法/数组/88.合并两个有序数组.md","filePath":"docs/03 博客/算法/数组/88.合并两个有序数组.md"}'),e={name:"docs/03 博客/算法/数组/88.合并两个有序数组.md"},l=p(`<p>直接合并后排序 双指针 逆向双指针</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>class Solution {</span></span>
