import{_ as a,c as s,o as n,a4 as p}from"./chunks/framework.4aTu-Nia.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/01 学习/课程/Golang/Go 面试/Slice 面试/Go 面试 | Go slice 扩容机制.md","filePath":"docs/01 学习/课程/Golang/Go 面试/Slice 面试/Go 面试 | Go slice 扩容机制.md"}'),c={name:"docs/01 学习/课程/Golang/Go 面试/Slice 面试/Go 面试 | Go slice 扩容机制.md"},e=p(`<p>扩容会发生在 slice append 的时候，当 slice 的 cap 不足以容纳新元素，就会进行扩容，扩容规则如下：</p><p>1、如果新申请容量比两倍原有容量大，那么扩容后容量大小为新申请容量</p><p>2、如果原有 slice 长度小于 1024， 那么每次就扩容为原来的 2 倍</p><p>3、如果原 slice 长度大于等于 1024， 那么每次扩容就扩为原来的 1.25 倍</p><p>代码示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>func main() {</span></span>
