import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.4aTu-Nia.js";const I=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/02 技术/运筹优化/ortools.md","filePath":"docs/02 技术/运筹优化/ortools.md"}'),l={name:"docs/02 技术/运筹优化/ortools.md"},e=p(`<p><a href="https://developers.google.com/optimization/routing" target="_blank" rel="noreferrer">https://developers.google.com/optimization/routing</a></p><p>以 mip 问题的求解为例，直接运行会报错误“java.lang.UnsatisfiedLinkError: no jniortools in java.library.path”</p><p>因为OR-Tools是一个C ++库，在Java中使用SWIG封装器（使用JNI调用等...），这是一个本机库而不是“纯粹的”java lib</p><p>因此创建 solver 前需要执行 loadNativeLibrariesPlus()</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span></span></span>
