import{_ as s,c as i,o as a,a4 as n}from"./chunks/framework.4aTu-Nia.js";const c=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/01 AI/AI 编程/Claude/写废 100 条提示词后，我用 3 步驯服了 Claude.md","filePath":"docs/01 AI/AI 编程/Claude/写废 100 条提示词后，我用 3 步驯服了 Claude.md"}'),l={name:"docs/01 AI/AI 编程/Claude/写废 100 条提示词后，我用 3 步驯服了 Claude.md"},h=n(`<p>Skills 是一个独立的功能包，它为 Claude 提供了专业的工作流、工具或领域知识。它们就像是 Claude 的“专属手册”，可以让 Claude 从一个通用助手变成一个特定领域的专家</p><p>以下是一个完整的指南，这个 Skill 可以系统地执行“元提示词生成 → 评估打分 → 最终优化”生成优质提示词</p><p>1）输入一句话生成元提示词</p><p>2）基于元提示词打分，并给出优化建议</p><p>3）基于元提示词和优化建议给出最终提示词</p><hr><h3 id="_1-创建-skill" tabindex="-1">1. 创建 Skill <a class="header-anchor" href="#_1-创建-skill" aria-label="Permalink to &quot;1. 创建 Skill&quot;">​</a></h3><h4 id="步骤-1-创建-skill-目录结构" tabindex="-1">步骤 1：创建 Skill 目录结构 <a class="header-anchor" href="#步骤-1-创建-skill-目录结构" aria-label="Permalink to &quot;步骤 1：创建 Skill 目录结构&quot;">​</a></h4><p>Skills 需要放在特定的目录中。你可以将其放在全局目录（<code>-/.claude/skills/</code>）或项目专用目录（<code>./.claude/skills/</code>）</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 假设你在全局目录下操作</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">	- </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;生成提示词&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> </span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">	- </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;提示词优化&quot;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">现在，我们可以开始了。请告诉我您的原始需求（第一步）。</span></span></code></pre></div><h4 id="步骤-3-添加辅助资源-可选" tabindex="-1">步骤 3：添加辅助资源（可选） <a class="header-anchor" href="#步骤-3-添加辅助资源-可选" aria-label="Permalink to &quot;步骤 3：添加辅助资源（可选）&quot;">​</a></h4><p>如果你的 Skill 需要特定的脚本、配置文件或示例代码，可以将它们一起放在同一目录下，Claude 可以直接引用这些资源</p><hr><h3 id="_2-安装与启用-skill" tabindex="-1">2. 安装与启用 Skill <a class="header-anchor" href="#_2-安装与启用-skill" aria-label="Permalink to &quot;2. 安装与启用 Skill&quot;">​</a></h3><h4 id="方式-1-手动加载-适合开发调试" tabindex="-1">方式 1：手动加载（适合开发调试） <a class="header-anchor" href="#方式-1-手动加载-适合开发调试" aria-label="Permalink to &quot;方式 1：手动加载（适合开发调试）&quot;">​</a></h4><p>如果你已经将 Skill 放在了 <code>.claude/skills/</code> 目录下，Claude Code 通常会自动发现并加载它。可以通过 /skills 命令查看已加载的 SKill</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/skills</span></span></code></pre></div><h4 id="方式-2-使用-marketplace-适合正式使用" tabindex="-1">方式 2：使用 Marketplace（适合正式使用） <a class="header-anchor" href="#方式-2-使用-marketplace-适合正式使用" aria-label="Permalink to &quot;方式 2：使用 Marketplace（适合正式使用）&quot;">​</a></h4><p>你可以将 Skill 打包发布到 GitHub，然后通过 Claude 的命令行工具进行安装</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 安装第三方 Skill</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">claude</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> skill</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ./my-first-skill</span></span></code></pre></div><hr><h3 id="_3-使用你的-skill" tabindex="-1">3. 使用你的 Skill <a class="header-anchor" href="#_3-使用你的-skill" aria-label="Permalink to &quot;3. 使用你的 Skill&quot;">​</a></h3><h4 id="方法-1-自动触发" tabindex="-1">方法 1：自动触发 <a class="header-anchor" href="#方法-1-自动触发" aria-label="Permalink to &quot;方法 1：自动触发&quot;">​</a></h4><p>当你在对话中输入触发词（如“提示词优化”）时，Claude 会自动加载并使用你的 Skill 提供建议</p><h4 id="方法-2-手动调用-slash-command" tabindex="-1">方法 2：手动调用（Slash Command） <a class="header-anchor" href="#方法-2-手动调用-slash-command" aria-label="Permalink to &quot;方法 2：手动调用（Slash Command）&quot;">​</a></h4><p>如果你想直接执行 Skill 的特定功能，可以使用斜杠命令：</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">/prompt-engineer</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> 优化周报</span></span></code></pre></div><p>这将手动触发名为 <code>prompt-engineer</code> 的 Skill 并传递参数 <code>优化周报</code></p><p><img src="https://muchuang-img.oss-cn-beijing.aliyuncs.com/20260220154150.png" alt=""></p><hr><h3 id="_4-测试与优化" tabindex="-1">4. 测试与优化 <a class="header-anchor" href="#_4-测试与优化" aria-label="Permalink to &quot;4. 测试与优化&quot;">​</a></h3><p>创建完 Skill 后，建议你进行几轮对话测试，确保触发条件准确，输出符合预期。你可以随时编辑 <code>SKILL.md</code> 并重新加载 Skill 来迭代改进</p><hr><h3 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h3><p>创建 Skill 的核心在于编写好 <code>SKILL.md</code> 文件中的前言（YAML）和详细的提示词（Prompt）。一旦熟悉了这个流程，你就可以构建出用于生成 PPT、审查 PR、重构代码等各种强大的自动化工具</p>`,38),t=[h];function p(k,e,d,E,r,o){return a(),i("div",null,t)}const y=s(l,[["render",p]]);export{c as __pageData,y as default};
