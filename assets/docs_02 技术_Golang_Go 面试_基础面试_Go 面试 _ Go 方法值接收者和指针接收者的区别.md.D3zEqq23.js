import{_ as s,c as n,o as a,a4 as t}from"./chunks/framework.4aTu-Nia.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/02 技术/Golang/Go 面试/基础面试/Go 面试 | Go 方法值接收者和指针接收者的区别.md","filePath":"docs/02 技术/Golang/Go 面试/基础面试/Go 面试 | Go 方法值接收者和指针接收者的区别.md"}'),p={name:"docs/02 技术/Golang/Go 面试/基础面试/Go 面试 | Go 方法值接收者和指针接收者的区别.md"},e=t(`<p>在 Go 语言中，方法可以有两种类型的接收者：值接收者（Value Receiver）和指针接收者（Pointer Receiver）。这两种接收者在方法定义和行为上有一些关键的区别：</p><p>1、<strong>值接收者</strong></p><p>当方法使用值接收者时，它在每次方法调用时都会获取接收者的一个副本。</p><p>这意味着方法对接收者的任何修改都不会影响原始对象。</p><p>值接收者适用于小型结构体或希望保持不可变性的情况。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>type MyStruct struct {</span></span>
