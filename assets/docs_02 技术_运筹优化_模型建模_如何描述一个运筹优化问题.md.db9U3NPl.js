import{_ as a,c as s,o as n,a4 as p}from"./chunks/framework.4aTu-Nia.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/02 技术/运筹优化/模型建模/如何描述一个运筹优化问题.md","filePath":"docs/02 技术/运筹优化/模型建模/如何描述一个运筹优化问题.md"}'),e={name:"docs/02 技术/运筹优化/模型建模/如何描述一个运筹优化问题.md"},l=p(`<p>向我描述运筹优化问题时，建议按以下结构来组织信息：</p><h2 id="_1-问题背景与目标" tabindex="-1">1. 问题背景与目标 <a class="header-anchor" href="#_1-问题背景与目标" aria-label="Permalink to &quot;1. 问题背景与目标&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>- 业务场景：什么业务问题需要优化？</span></span>
...
<span class="line"><span>- 拣货员数量与容量</span></span></code></pre></div><p>按这个结构描述，我能更好地理解问题并帮你：</p><ol><li>建立数学模型</li><li>选择合适的求解方法</li><li>编写求解代码</li><li>分析结果</li></ol>`,17),i=[l];function t(c,o,d,h,r,u){return n(),s("div",null,i)}const g=a(e,[["render",t]]);export{b as __pageData,g as default};
