import{_ as n,c as s,o as a,a4 as p}from"./chunks/framework.4aTu-Nia.js";const m=JSON.parse('{"title":"一、为什么要控制 goroutine 并发的数量？","description":"","frontmatter":{},"headers":[],"relativePath":"docs/01 学习/课程/Golang/Go 面试/Goroutine 面试/Go 面试 | Go 如何控制并发的 goroutine 数量.md","filePath":"docs/01 学习/课程/Golang/Go 面试/Goroutine 面试/Go 面试 | Go 如何控制并发的 goroutine 数量.md"}'),e={name:"docs/01 学习/课程/Golang/Go 面试/Goroutine 面试/Go 面试 | Go 如何控制并发的 goroutine 数量.md"},l=p(`<h1 id="一、为什么要控制-goroutine-并发的数量" tabindex="-1">一、为什么要控制 goroutine 并发的数量？ <a class="header-anchor" href="#一、为什么要控制-goroutine-并发的数量" aria-label="Permalink to &quot;一、为什么要控制 goroutine 并发的数量？&quot;">​</a></h1><p>在开发过程中，如果不对 goroutine 加以控制而进行滥用的话，可能会导致服务整体崩溃。比如耗尽系统资源导致程序崩溃，或者 CPU 使用率过高导致系统忙不过来。</p><h1 id="二、用什么方法控制-goroutine-并发的数量" tabindex="-1">二、用什么方法控制 goroutine 并发的数量？ <a class="header-anchor" href="#二、用什么方法控制-goroutine-并发的数量" aria-label="Permalink to &quot;二、用什么方法控制 goroutine 并发的数量？&quot;">​</a></h1><h2 id="一-有缓冲-channel" tabindex="-1">一）有缓冲 channel <a class="header-anchor" href="#一-有缓冲-channel" aria-label="Permalink to &quot;一）有缓冲 channel&quot;">​</a></h2><p>利用缓冲满时发送阻塞的特性</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package main</span></span>
