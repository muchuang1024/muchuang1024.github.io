import{_ as s,c as a,o as n,a4 as p}from"./chunks/framework.4aTu-Nia.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/01 学习/课程/Golang/Go 面试/并发面试/Go 面试 | Go 如何排查数据竞争问题.md","filePath":"docs/01 学习/课程/Golang/Go 面试/并发面试/Go 面试 | Go 如何排查数据竞争问题.md"}'),e={name:"docs/01 学习/课程/Golang/Go 面试/并发面试/Go 面试 | Go 如何排查数据竞争问题.md"},t=p(`<p>1、概念</p><p>只要有两个以上的 goroutine 并发访问同一变量，且至少其中的一个是写操作的时候就会发生数据竞争；全是读的情况下是不存在数据竞争的。</p><p>2、排查方式</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package main</span></span>
