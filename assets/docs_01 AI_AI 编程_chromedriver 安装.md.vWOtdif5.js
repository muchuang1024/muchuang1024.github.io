import{_ as s,c as a,o as n,a4 as e}from"./chunks/framework.4aTu-Nia.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/01 AI/AI 编程/chromedriver 安装.md","filePath":"docs/01 AI/AI 编程/chromedriver 安装.md"}'),p={name:"docs/01 AI/AI 编程/chromedriver 安装.md"},o=e(`<p>安装依赖</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>sudo yum update -y</span></span>
