import{_ as s,c as a,o as n,a4 as p}from"./chunks/framework.4aTu-Nia.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/03 博客/教程/搭建 AI 微信机器人.md","filePath":"docs/03 博客/教程/搭建 AI 微信机器人.md"}'),e={name:"docs/03 博客/教程/搭建 AI 微信机器人.md"},o=p(`<h2 id="一、效果展示" tabindex="-1">一、效果展示 <a class="header-anchor" href="#一、效果展示" aria-label="Permalink to &quot;一、效果展示&quot;">​</a></h2><h2 id="一、准备大模型账号" tabindex="-1">一、准备大模型账号 <a class="header-anchor" href="#一、准备大模型账号" aria-label="Permalink to &quot;一、准备大模型账号&quot;">​</a></h2><p>购买画图</p><p><img src="https://muchuang-img.oss-cn-beijing.aliyuncs.com/20240510205333.png" alt="image.png"></p><p><img src="https://muchuang-img.oss-cn-beijing.aliyuncs.com/20240510205440.png" alt=""></p><h2 id="一、安装-docker" tabindex="-1">一、安装 Docker <a class="header-anchor" href="#一、安装-docker" aria-label="Permalink to &quot;一、安装 Docker&quot;">​</a></h2><p>前往 <a href="https://docs.docker.com/engine/install/" target="_blank" rel="noreferrer">docker官网</a> 进行下载安装，安装后，在命令行 执行命令 <code>docker -v</code> ，如果出现版本号则代表安装成功</p><p>1、创建项目文件夹</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>mkdir wechat-bot</span></span>
