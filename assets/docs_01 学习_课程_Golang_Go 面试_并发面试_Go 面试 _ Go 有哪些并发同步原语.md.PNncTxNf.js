import{_ as n,c as s,o as a,a4 as p}from"./chunks/framework.4aTu-Nia.js";const g=JSON.parse('{"title":"一、原子操作","description":"","frontmatter":{},"headers":[],"relativePath":"docs/01 学习/课程/Golang/Go 面试/并发面试/Go 面试 | Go 有哪些并发同步原语.md","filePath":"docs/01 学习/课程/Golang/Go 面试/并发面试/Go 面试 | Go 有哪些并发同步原语.md"}'),l={name:"docs/01 学习/课程/Golang/Go 面试/并发面试/Go 面试 | Go 有哪些并发同步原语.md"},t=p(`<p>Go 是一门以并发编程见长的语言，它提供了一系列的同步原语方便开发者使用</p><h1 id="一、原子操作" tabindex="-1">一、原子操作 <a class="header-anchor" href="#一、原子操作" aria-label="Permalink to &quot;一、原子操作&quot;">​</a></h1><p>Mutex、RWMutex 等并发原语的底层实现是通过 atomic 包中的一些原子操作来实现的，原子操作是最基础的并发原语</p><p><img src="https://cdn.jsdelivr.net/gh/caijinlin/imgcdn/53d55255fe851754659d90cbee814f13.jpg#id=pah1N&amp;originHeight=1693&amp;originWidth=2250&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;status=done&amp;style=none&amp;title=#id=FSY1f&amp;originHeight=1693&amp;originWidth=2250&amp;originalType=binary&amp;ratio=1&amp;rotation=0&amp;showTitle=false&amp;status=done&amp;style=none&amp;title=" alt=""></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package main</span></span>
