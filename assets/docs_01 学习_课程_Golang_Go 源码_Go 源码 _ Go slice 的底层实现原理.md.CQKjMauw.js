import{_ as s,c as a,o as n,a4 as e}from"./chunks/framework.4aTu-Nia.js";const m=JSON.parse('{"title":"一、基本概念","description":"","frontmatter":{},"headers":[],"relativePath":"docs/01 学习/课程/Golang/Go 源码/Go 源码 | Go slice 的底层实现原理.md","filePath":"docs/01 学习/课程/Golang/Go 源码/Go 源码 | Go slice 的底层实现原理.md"}'),p={name:"docs/01 学习/课程/Golang/Go 源码/Go 源码 | Go slice 的底层实现原理.md"},l=e(`<h1 id="一、基本概念" tabindex="-1">一、基本概念 <a class="header-anchor" href="#一、基本概念" aria-label="Permalink to &quot;一、基本概念&quot;">​</a></h1><p>切片是基于数组实现的，它的底层是数组，可以理解为对 底层数组的抽象，源码包中 src/runtime/slice.go 定义了 slice 的数据结构</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>type slice struct {</span></span>
