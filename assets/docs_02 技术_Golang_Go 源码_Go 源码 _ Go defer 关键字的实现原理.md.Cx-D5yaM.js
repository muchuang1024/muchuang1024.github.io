import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.4aTu-Nia.js";const g=JSON.parse('{"title":"一、基本概念","description":"","frontmatter":{},"headers":[],"relativePath":"docs/02 技术/Golang/Go 源码/Go 源码 | Go defer 关键字的实现原理.md","filePath":"docs/02 技术/Golang/Go 源码/Go 源码 | Go defer 关键字的实现原理.md"}'),e={name:"docs/02 技术/Golang/Go 源码/Go 源码 | Go defer 关键字的实现原理.md"},l=p(`<h1 id="一、基本概念" tabindex="-1">一、基本概念 <a class="header-anchor" href="#一、基本概念" aria-label="Permalink to &quot;一、基本概念&quot;">​</a></h1><p>defer 能够让我们推迟执行某些函数调用，推迟到当前函数返回前才实际执行。defer 与 panic 和 recover 结合，形成了 Go 语言风格的异常与捕获机制。</p><p>使用场景：defer 语句经常被用于处理成对的操作，如文件句柄关闭、连接关闭、释放锁</p><p>优点：方便开发者使用</p><p>缺点：有性能损耗</p><h1 id="二、实现原理" tabindex="-1">二、实现原理 <a class="header-anchor" href="#二、实现原理" aria-label="Permalink to &quot;二、实现原理&quot;">​</a></h1><p>在 Go 语言中，defer 的先进后出（后进先出）的执行顺序是由编译器实现的，它通过在函数退出点插入 defer 语句的调用代码，确保这些语句按照与它们被添加到栈的相反顺序执行。</p><p>源代码：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>func A(i int) {</span></span>
