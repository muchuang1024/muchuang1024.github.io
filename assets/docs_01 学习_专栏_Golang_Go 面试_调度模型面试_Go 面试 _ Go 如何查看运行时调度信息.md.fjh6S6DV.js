import{_ as s,c as a,o as n,a4 as p}from"./chunks/framework.4aTu-Nia.js";const m=JSON.parse('{"title":"一、go tool trace","description":"","frontmatter":{},"headers":[],"relativePath":"docs/01 学习/专栏/Golang/Go 面试/调度模型面试/Go 面试 | Go 如何查看运行时调度信息.md","filePath":"docs/01 学习/专栏/Golang/Go 面试/调度模型面试/Go 面试 | Go 如何查看运行时调度信息.md"}'),t={name:"docs/01 学习/专栏/Golang/Go 面试/调度模型面试/Go 面试 | Go 如何查看运行时调度信息.md"},e=p(`<p>有 2 种方式可以查看一个程序的调度 GMP 信息，分别是 go tool trace 和 GODEBUG</p><p>比如 trace.go 代码如下</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>package main</span></span>
