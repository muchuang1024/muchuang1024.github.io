import{_ as s,c as a,o as n,a4 as i}from"./chunks/framework.4aTu-Nia.js";const E=JSON.parse('{"title":"四、自动更新","description":"","frontmatter":{},"headers":[],"relativePath":"docs/03 博客/教程/VitePress 搭建个人博客教程.md","filePath":"docs/03 博客/教程/VitePress 搭建个人博客教程.md"}'),p={name:"docs/03 博客/教程/VitePress 搭建个人博客教程.md"},e=i(`<p><strong>自媒体平台那么多，为什么还要搭建自己的博客？</strong></p><p>1）在自媒体平台上，你受限于平台的规则和算法，而在博客上，你可以自由地表达自己的想法，不受任何限制</p><p>2）搜索引擎优化：博客通常更容易被搜索引擎收录，通过优化关键词和内容，可以吸引更多的流量</p><p>3）建立个人品牌：博客是建立和展示个人专业形象和品牌的理想场所。通过持续发布高质量的内容，你可以成为某个领域的意见领袖，吸引一群忠实的读者</p><p><strong>为什么选择 VitePress ？</strong></p><p>1）不用一直折腾，专心写作。从最早用的 WordPress、Hexo、掘金等，每次都会有新的平台出来，耗费太多精力</p><p>2）内容基于 Markdown 编写。自己用 Markdown 写的笔记，就可以生成博客</p><p>VitePress 是一款<a href="https://en.wikipedia.org/wiki/Static_site_generator" target="_blank" rel="noreferrer">静态站点生成器</a> (SSG) ，专为构建快速、以内容为中心的网站而设计。简而言之，VitePress 获取用 <a href="https://en.wikipedia.org/wiki/Markdown" target="_blank" rel="noreferrer">Markdown</a> 编写的源内容，为其应用主题，并生成可以轻松部署在任何地方的静态 HTML 页面。</p><p>本文将介绍通过 VitePress 基于 Markdown 笔记文档生成博客，以及笔记发生变化时，自动更新博客</p><p>最终的效果如下：<a href="https://muchuang1024.github.io/" target="_blank" rel="noreferrer">https://muchuang1024.github.io/</a></p><p><img src="https://muchuang-img.oss-cn-beijing.aliyuncs.com/20240517215656.png" alt=""></p><p><img src="https://muchuang-img.oss-cn-beijing.aliyuncs.com/20240517215743.png" alt=""></p><h2 id="一、创建笔记仓库" tabindex="-1">一、创建笔记仓库 <a class="header-anchor" href="#一、创建笔记仓库" aria-label="Permalink to &quot;一、创建笔记仓库&quot;">​</a></h2><p>为了笔记文档和博客网站分开管理，所以需要单独创建一个笔记仓库</p><p>在 Github 创建好笔记仓库 docs.git，拉取到本地，添加 Markdown 笔记并提交即可</p><h2 id="二、创建博客仓库" tabindex="-1">二、创建博客仓库 <a class="header-anchor" href="#二、创建博客仓库" aria-label="Permalink to &quot;二、创建博客仓库&quot;">​</a></h2><p>在 Github 创建好博客仓库 username.github.io.git，拉取到本地</p><h3 id="_1、安装-vitepress-依赖" tabindex="-1">1、安装 VitePress 依赖 <a class="header-anchor" href="#_1、安装-vitepress-依赖" aria-label="Permalink to &quot;1、安装 VitePress 依赖&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>yarn add -D vitepress</span></span></code></pre></div><h3 id="_2、构建项目" tabindex="-1">2、构建项目 <a class="header-anchor" href="#_2、构建项目" aria-label="Permalink to &quot;2、构建项目&quot;">​</a></h3><p>VitePress 附带一个脚手架，可帮助您构建基本项目</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>npx vitepress init</span></span></code></pre></div><p>输入相应设置，自动生成相关代码</p><p><img src="https://muchuang-img.oss-cn-beijing.aliyuncs.com/20240329214827.png" alt=""></p><h3 id="四-项目目录结构" tabindex="-1">四）项目目录结构 <a class="header-anchor" href="#四-项目目录结构" aria-label="Permalink to &quot;四）项目目录结构&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>.vitepress： VitePress 配置</span></span>
<span class="line"><span>package.json：依赖管理</span></span>
<span class="line"><span>node_modules: 安装的依赖</span></span>
<span class="line"><span>*.md:  markdown 文件</span></span></code></pre></div><p><img src="https://muchuang-img.oss-cn-beijing.aliyuncs.com/20240329215413.png" alt=""></p><p>配置文件 ( <code>.vitepress/config.mts</code>) 允许自定义 VitePress 站点的各个配置</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { defineConfig } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;vitepress&#39;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        link: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;/markdown-examples&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    ],</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">            link: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;/api-examples&#39;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">          }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        ]</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">      }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    ],</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    ]</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">})</span></span></code></pre></div><h3 id="五-创建-markdown-目录" tabindex="-1">五）创建 markdown 目录 <a class="header-anchor" href="#五-创建-markdown-目录" aria-label="Permalink to &quot;五）创建 markdown 目录&quot;">​</a></h3><p>文档和 vitepress 网站分开管理，使用一个软链接，链接到你的本地文档目录 docs</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>ln -s ../docs docs</span></span></code></pre></div><p>vitepress 默认不支持软链接，解决存放文档的路径是个软链接时，页面显示 404 的问题</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>https://github.com/vuejs/vitepress/pull/2780</span></span>
<span class="line"><span>https://github.com/vuejs/vitepress/issues/1496#issuecomment-1282493417</span></span>
<span class="line"><span></span></span>
<span class="line"><span>\`.vitepress/config.mts\` 文件添加如下设置</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>		}</span></span>
<span class="line"><span>	}</span></span>
<span class="line"><span>})</span></span></code></pre></div><h3 id="六-自动生成侧边栏" tabindex="-1">六）自动生成侧边栏 <a class="header-anchor" href="#六-自动生成侧边栏" aria-label="Permalink to &quot;六）自动生成侧边栏&quot;">​</a></h3><p>侧边栏默认通过 sidebar 字段配置</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">sidebar</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: [</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    text: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;Examples&#39;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">,</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    items: [</span></span>
...
<span class="line"><span>          ref: gh-pages</span></span></code></pre></div>`,82),l=[e];function t(h,c,k,d,o,r){return n(),a("div",null,l)}const u=s(p,[["render",t]]);export{E as __pageData,u as default};
