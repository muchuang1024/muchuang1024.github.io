import{_ as a,c as n,o as s,a4 as p}from"./chunks/framework.4aTu-Nia.js";const g=JSON.parse('{"title":"一、如何提问","description":"","frontmatter":{},"headers":[],"relativePath":"docs/03 博客/开发/自动生成目录.md","filePath":"docs/03 博客/开发/自动生成目录.md"}'),e={name:"docs/03 博客/开发/自动生成目录.md"},l=p(`<p>做一个工具，最重要的确定输入和输出，你不用关心 AI 是怎么做的？ AI 根据你的输入和输出，自动帮你写出代码</p><p>所以使用 AI 辅助做一款工具，最主要的 2 点：</p><p>1、写好提示词（主要是输入和输出）</p><p>2、运行脚本代码（掌握如何运行代码）</p><p>本文将从 0 到 1，带你实现一个 自动生成文章目录的工具</p><h1 id="一、如何提问" tabindex="-1">一、如何提问 <a class="header-anchor" href="#一、如何提问" aria-label="Permalink to &quot;一、如何提问&quot;">​</a></h1><p>写好的提示词的前提是懂得如何提问，然后设计出自己的提示词，最后根据输出结果进行迭代优化</p><p>当你不清楚该怎么提问时，可以直接向 AI 请教</p><h2 id="一-提示词" tabindex="-1">一）提示词 <a class="header-anchor" href="#一-提示词" aria-label="Permalink to &quot;一）提示词&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>现在你是一个技术专家，擅长开发各种工具，我现在需要你开发一个脚本工具，为存储在本地文件夹中的文章自动生成目录</span></span>
